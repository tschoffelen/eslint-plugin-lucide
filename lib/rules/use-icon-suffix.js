      ...
      ImportDeclaration(node) {
        ...
        node.specifiers.forEach((specifier) => {
          if (specifier.type === "ImportSpecifier") {
            ...
            // We won't enforce the suffix for LucideProps as it's a common type used for props and not an icon component
            if (importedName === "LucideProps") {
              return;
            }
            ...
            context.report({
              ...
              fix(fixer) {
                ...
                if (importedName !== localName) {
                  ...
                  fixes.push(fixer.replaceText(specifier.local, newLocalName));
                } else {
